...
export const metadata: Metadata = {
  ...
  description: "A transparent, privacy-first platform connecting people, volunteers, and verified child-care organizations to provide technology, digital education, refurbished devices, and educational supplies.",

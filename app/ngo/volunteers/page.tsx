    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      <div>
        ...
        <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
          Assigned Volunteer Mentors
        </h1>
        <p className="text-xs text-slate-500">
          Review verified software mentors, scheduled workshop modules, and logged teaching hours.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {volunteerProfiles.map((vol) => (
          <div key={vol.id} className="bg-white rounded-3xl border border-slate-200 p-6 space-y-4 shadow-xs">
